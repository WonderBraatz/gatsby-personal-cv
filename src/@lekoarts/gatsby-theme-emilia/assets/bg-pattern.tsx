...
const BGPattern = () => (
  ...
  >
    <pattern id="tet" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse" fillRule="evenodd" clipRule="evenodd" fill="currentColor">
    ...
    <rect x="0" y="0" width="100%" height="100%" fill="url(#tet)" />
  </svg>
);
